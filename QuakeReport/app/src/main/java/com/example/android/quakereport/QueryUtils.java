...
public final class QueryUtils {
     ...
     */
    public static ArrayList<QuakeInfo> extractEarthquakes(String stringUrl) {
    ...
    private static ArrayList<QuakeInfo> extractFromJson(String jsonString){
